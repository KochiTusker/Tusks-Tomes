...
export type ProviderName = 'gemini' | 'geminiFree' | 'claude' | 'openai'

export type ProvidersSummary = {
  configured: Array<'gemini' | 'geminiFallback' | 'claude' | 'openai' | 'claudeCode' | 'codex'>
...
export type AvailabilitySlot = 'gemini' | 'geminiFallback' | 'claude' | 'openai'
