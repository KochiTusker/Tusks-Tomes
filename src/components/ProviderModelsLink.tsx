...
export function ProviderModelsLink() {
  ...
  return (
    ...
    >
      <Cog className="mr-1 h-3.5 w-3.5 shrink-0" />
      {/* The provider label runs long ("Claude Code (your subscription)")
          and the button did not shrink, so on a phone it pushed the page
          12px wider than the viewport. Truncate instead — the full text
