      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            parameter count, and {specs?.gpu.detected ? `${specs.gpu.vramGb}GB of detected VRAM` : 'whatever VRAM the legacy Hardware profile reports'}. Apply via Hybrid Routing below.
          </CardDescription>
        </CardHeader>
        <CardContent>
