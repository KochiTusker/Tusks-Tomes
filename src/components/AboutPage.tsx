// About page — animated header, a lean bullet list of convictions, a
// two-sentence creator blurb, three source/license/version chips, and a
// quiet BMAC footer, in Tomes' arcane palette.
