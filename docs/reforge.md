# 🪄 Chronicle Reforge — redo the later phases on a different model
...
when running on a [Claude Code subscription](add-ons/claude-code.md), where the
...
2. **Choose what to produce:**
   ...
   - **Condensed recap** — a tightened retelling plus catch-up bullets, in the
     selected voice.
   - **Voice** — any installed [Persona](add-ons/personas.md) (or the default
