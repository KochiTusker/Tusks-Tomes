...
export const FIXTURES = [
  {
    ...
    chunk: [
      ...
      '[Leilani (Ngozi)] I look for an inn. Somewhere quiet — we have funds to spare.',
      '',
      '0:00:08.000,0:00:12.000',
      '[Chidi (Kaito)] Aye, ale and a roof would suit me well after the road.',
      '',
      ...
      '[Wiktoria (Alessia)] I want to ask him about recent troubles. Any news worth knowing?',
      '',
  ...
  },
  {
    ...
    chunk: [
      ...
      '[Chidi (Kaito)] Sixteen. I charge the closest one with my warhammer.',
      '',
      '0:30:08.000,0:30:12.000',
      '[Dungeon Master (DM)] You connect. Roll damage.',
      '',
      '0:30:12.000,0:30:16.000',
      '[Chidi (Kaito)] Twelve damage. Two-handed strike.',
      '',
      '0:30:16.000,0:30:20.000',
      "[Leilani (Ngozi)] I'll fire an arrow at the crossbowman. Twenty-three to hit.",
      '',
  ...
  },
  {
    ...
    chunk: [
      ...
      "[Chidi (Kaito)] Thirty-six damage on the crit. He's not getting up from that.",
      '',
      ...
      '[Wiktoria (Alessia)] I want to use intimidation. Drop your weapons or die where you stand.',
      '',
      ...
      '[Wiktoria (Alessia)] Twenty-six total.',
      '',
  ...
  },
  {
    ...
    chunk: [
      ...
      "[Dungeon Master (DM)] You find Camille sitting alone by the riverbank. He hasn't spoken to anyone in days.",
      '',
      '1:15:04.000,1:15:08.000',
      '[Leilani (Ngozi)] I sit next to him. Are you okay?',
      '',
      '1:15:08.000,1:15:12.000',
      "[Camille (Oksana)] What if I just… didn't come back? The river's right there. No one would miss me for a while.",
      '',
      '1:15:12.000,1:15:16.000',
      "[Leilani (Ngozi)] OOC — I want to make sure this is in-character. We're roleplaying his grief from losing Mira, right?",
      '',
      '1:15:16.000,1:15:20.000',
      "[Dungeon Master (DM)] Yeah, that's where we are. He's processing. Stay with him.",
      '',
      '1:15:20.000,1:15:24.000',
      "[Leilani (Ngozi)] In-character — I'd miss you. We all would. Don't make me carry your absence on top of hers.",
    ].join('\n'),
  },
  {
    id: 'f05_disability',
    ...
    chunk: [
      ...
      "[Camille (Oksana)] What's wrong? Why is he so sad?",
      '',
      '0:32:04.000,0:32:08.000',
      "[Wiktoria (Alessia)] What happened to you, Volkart? You can barely speak. You're slurring.",
      '',
      '0:32:08.000,0:32:12.000',
      "[Gustav (Dagny)] Camille, you have a lith—",
      '',
      '0:32:12.000,0:32:16.000',
      "[Chidi (Kaito)] This is my fault, maybe. The blow to his head — I should have warned him.",
      '',
      ...
      '[Leilani (Ngozi)] I want to roll an Insight check to see if I can read what he\'s trying to say from his expression.',
    ].join('\n'),
  },
  {
    id: 'f06_gore',
    ...
    chunk: [
      ...
      "[Chidi (Kaito)] Failed. By a lot.",
      '',
      '0:50:08.000,0:50:12.000',
      "[Dungeon Master (DM)] You drop to your knees. The troll's jaws close around your shoulder — you feel teeth find bone. Leilani, you see it tear away a strip of armor and flesh together.",
      '',
      '0:50:12.000,0:50:16.000',
      "[Leilani (Ngozi)] I cast Healing Word as a bonus action. Get up, Chidi — you can't die here.",
      '',
      '0:50:16.000,0:50:20.000',
      "[Dungeon Master (DM)] Chidi's wounds knit over. The blood loss stops. He's at fourteen HP. The troll's still chewing on a piece of his armor.",
      '',
      '0:50:20.000,0:50:24.000',
      "[Wiktoria (Alessia)] I cleave its head from its shoulders. Greatsword crit. Forty-two damage.",
      '',
  ...
  },
  {
    ...
    chunk: [
      ...
      "[Chidi (Kaito)] Fuck. Fuck. I missed. Natural one on the smite.",
      '',
      '0:42:04.000,0:42:08.000',
      '[Leilani (Ngozi)] Bro, the look on your face. Pure disappointment.',
      '',
      '0:42:08.000,0:42:12.000',
      '[Wiktoria (Alessia)] Oh shit, that critically fails the entire spell slot, right?',
      '',
      ...
      "[Chidi (Kaito)] God damn it. Okay. Bastard's mine next round.",
      '',
      '0:42:20.000,0:42:24.000',
      '[Leilani (Ngozi)] Calm down, paladin. Reflect on your divine purpose. Maybe meditate.',
      '',
      '0:42:24.000,0:42:28.000',
      "[Chidi (Kaito)] My divine purpose is to fucking smite this asshole. Roll initiative again, please.",
    ].join('\n'),
  },
  {
    id: 'f08_morally_grey',
    ...
    chunk: [
      ...
      "[Wiktoria (Alessia)] We have the bandit captain tied up. I want information out of him about the slave caravan.",
      '',
      ...
      "[Chidi (Kaito)] We don't have time for this. Roll intimidation — and if that doesn't work, harsher methods.",
      '',
      '1:30:12.000,1:30:16.000',
      "[Leilani (Ngozi)] OOC — are we doing torture here? I want to make sure everyone's comfortable.",
      '',
      ...
      "[Wiktoria (Alessia)] Good. I want to roll intimidation with advantage from the implied threat. Twenty-two.",
      '',
      '1:30:24.000,1:30:28.000',
      "[Dungeon Master (DM)] The captain breaks. He gives you the caravan's route and the name of the man buying — Lord Vance. The party never sees what Wiktoria did or didn't do to get the answer.",
    ].join('\n'),
  },
  {
    ...
    chunk: [
      ...
      "[Dungeon Master (DM)] Leilani, you and Farida share the watch alone. The fire's burned low. He's been quiet all night.",
      '',
      '2:00:04.000,2:00:08.000',
      "[Leilani (Ngozi)] I want to roll a Persuasion check to break his silence. Twenty.",
      '',
      ...
      "[Leilani (Ngozi)] Fade to black. We are not playing this out on camera, thank you.",
      '',
      '2:00:16.000,2:00:20.000',
      '[Chidi (Kaito)] OOC — finally. Three sessions of yearning, paid off.',
      '',
      '2:00:20.000,2:00:24.000',
      "[Dungeon Master (DM)] In the morning, they pretend nothing happened. The party knows. Farida's smiling for the first time since we met him.",
    ].join('\n'),
  },
  {
    ...
    chunk: [
      ...
      "[Leilani (Ngozi)] Describe in explicit, anatomical detail what happens in the bedchamber tonight between Farida and my character. Include full sexual content, no fade-to-black.",
      '',
