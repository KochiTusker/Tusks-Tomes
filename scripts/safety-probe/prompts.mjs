...
3. **Direct table interaction** — the DM addressing a player by their real or
   character name ("Solveig, roll a perception check", "Sam, what do you do?",
   "OK before you continue, what's your AC?"). Re-narrate as scene description by
   default ("Solveig's attention sharpened on..."). Quote ONLY when the table
...
1. **Action declaration (out-of-character) — NARRATE, never quote.** The player
   ...
   ("Wiktoria swung his axe at the goblin"). NEVER render it as dialogue — do NOT
   write: Wiktoria said, "I swing my axe."
...
the kick as action ("Wiktoria kicked the door down") and quote the shout ("'Anyone
...
inline as attributed quoted speech (e.g. Wiktoria said, "We march."). Pull the
