...
const CHRONICLE = `The pre-game chatter was a familiar cacophony. Lucia steered the table back to order while Eero made his political opinions known. The Dungeon Master's voice boomed across the arena: "Welcome to the main event! Tonight, we are throwing out the rule books. We are setting the tree on fire! Prepare yourselves for a colossal, textbook-shattering tag team collision!"
...
Then Stardust and Pentagon emerged from pyrotechnics. Lucia, as Stardust, played to the kids in the front row. Thao, as Pentagon, launched himself into a backflip, sparks flying around him on cue.

The match began with Lucia attempting a low-risk jab on the Underminer. He rolled poorly. The Underminer blocked and immediately launched into a suplex — but rolled a one. Lucia reversed, hoisting the Underminer up and slamming him down onto the mat. He performed a mocking gesture, sticking his tongue out at the crowd in the most provocative way possible. The crowd roared. Two hype points. He needed five to attempt a pin.
