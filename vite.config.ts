...
export default defineConfig({
  ...
  test: {
    ...
    // The scripts/ glob picks up the release-gate scanner tests (mjs)
    // — these are the load-bearing OSINT-protection regression suite,
    // so they MUST run on every push.
    include: [
      'src/**/*.test.ts',
      'src/**/*.test.tsx',
      'server/**/*.test.ts',
