 ...
 * caller that writes *valid but wrong* content over good data — an empty
 * document written over a populated one is valid, and without history the
 * entries it replaced are unrecoverable.
 *
...
export function openrouterCatalogueFile(): string {
