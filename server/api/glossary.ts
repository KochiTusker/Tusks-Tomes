 ...
 *
 * That distinction is load-bearing. A seed is copied into every install on
 * first run, so anything sitting in it is not an example of a campaign — it
 * becomes part of the product. Keep the entries invented.
 *
